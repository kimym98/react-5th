function NavContents() {
  ...
  const handleClickResponding = (e: React.MouseEvent<HTMLAnchorElement>) => {
    e.preventDefault();
    console.log("responding");
    e.currentTarget.dataset.element = "responding-to-events";
  };
  return (
    <nav className="NavContents" aria-label="학습 주제 탑색">
      <a href="#jsx-markup" onClick={handleClickFirstLink}>
        JSX 마크업
      </a>
      <a href="#responding-to-events" onClick={handleClickResponding}>
        이벤트 응답
      </a>
    </nav>
  );
