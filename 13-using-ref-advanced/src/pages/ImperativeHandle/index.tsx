...
const INITIAL_CHAT_MESSAGE = [
  ...
  {
    id: "chat-5",
    message: "나는 오늘 맛있는 회가 먹고 싶어! 숙성회 어때?",
    isMe: false,
  },
  { id: "chat-6", message: "너무 좋은 생각이다~~ 알았어~~", isMe: true },
  {
    id: "chat-7",
    message: "좋아 좀 있다 별내역 2번 출구에서 만나자!",
    isMe: false,
  },
];
...
function ImperativeHandle() {
  ...
  const imperativeHandleRef = useRef<ChatBoxHandle | null>(null);

  //상태 업데이트 채팅 메시지 목록에서 새메시지 추가기능
  ...
  return (
    <main className={S.container} ref={mountedMainElement}>
      ...
      <div className={S.description}>
        ...
        <p>
          때때로 DOM요소 노도에 대한 접근을 허용하지 않고, 명령형 핸들(함수)를
          노출하는 방법에 대해 학습해봅시다.
        </p>
        <p>
          이런 경우
